...
import type { ReactiveStore, Writable } from "../store/initialState";
import type {
	DefaultEdgeOptions,
	Edge,
	FitViewOptions,
...
export type ReactiveEdgeLookup<EdgeType extends EdgeBase = EdgeBase> =
	ReactiveMap<string, EdgeType>;
export type ReactiveConnectionLookup = ReactiveMap<
	string,
	ReactiveMap<string, HandleConnection>
>;

type ConnectionStartHandle = Writable<
...
> = {
	...
	parentLookup: ReactiveMap<
		string,
		ReactiveMap<string, InternalNodeBase<NodeBase>>
	>;
	...
	onSelectionChangeHandlers: Writable<
		OnSelectionChangeFunc<NodeType, EdgeType>[]
	>;
...
export type ReactFlowActions<NodeType extends Node, EdgeType extends Edge> = {
	...
	unselectNodesAndEdges: (
		params?: UnselectNodesAndEdgesParams<NodeType, EdgeType>,
	) => void;
