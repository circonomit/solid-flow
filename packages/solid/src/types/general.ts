...
export type OnNodesDelete<NodeType extends Node = Node> = (
	nodes: NodeType[],
) => void;
export type OnEdgesDelete<EdgeType extends Edge = Edge> = (
	edges: EdgeType[],
) => void;
...
export type OnSelectionChangeFunc<
	NodeType extends Node = Node,
	EdgeType extends Edge = Edge,
> = (params: OnSelectionChangeParams<NodeType, EdgeType>) => void;

export type FitViewParams<NodeType extends Node = Node> =
	FitViewParamsBase<NodeType>;
